...
function RayfieldLibrary:CreateWindow(Settings)
    ...
    -- Ultimate Logo Implementation
    local Logo = Instance.new("ImageLabel")
    Logo.Name = "UltimateLogo"
    Logo.Size = UDim2.new(0, 100, 0, 100)
    Logo.Position = UDim2.new(0.5, -50, 0.45, -50)
    Logo.BackgroundTransparency = 1
    Logo.Image = Settings.Logo or "rbxassetid://6031280306" -- Placeholder
    Logo.ImageTransparency = 1
    Logo.Parent = LoadingFrame

    TweenService:Create(Logo, TweenInfo.new(1, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {ImageTransparency = 0, Size = UDim2.new(0, 120, 0, 120), Position = UDim2.new(0.5, -60, 0.45, -60)}):Play()
    
    task.spawn(function()
        local breathing = true
        Main.Destroying:Connect(function() breathing = false end)
        while breathing do
            TweenService:Create(Logo, TweenInfo.new(1.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {Size = UDim2.new(0, 110, 0, 110), Position = UDim2.new(0.5, -55, 0.45, -55)}):Play()
            task.wait(1.5)
            TweenService:Create(Logo, TweenInfo.new(1.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {Size = UDim2.new(0, 120, 0, 120), Position = UDim2.new(0.5, -60, 0.45, -60)}):Play()
            task.wait(1.5)
        end
    end)
